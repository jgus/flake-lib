...
{ pkgs, source, pinSchema, branchOwnedFiles ? [ "pin.nix" "flake.lock" ], versionOverrides ? { }, versionCanon ? [ ], excludePrereleases ? false, includePrereleaseAggregates ? false, minVersionComponents ? 3 }:
